...
<div class="cont">
    ...
    <div class="contl">
        ...
        <!--面包屑导航-->
        <div class="navbred"><span>您当前的位置：</span><a href="">搜索结果</a>
        </div>
        <div class="boxcont">
            <?php if(is_array($search_data)): $i = 0; $__LIST__ = $search_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U($vo['url'].'/'.$vo['article_id']);?>"><div class="boxitem">
                <div class="imglimt"><img src="<?php echo ($vo["titleimg"]); ?>" alt="<?php echo ($vo["title"]); ?>" /></div>
                <h2><?php echo ($vo["title"]); ?></h2>
                <h3><?php echo ($vo["synopsis"]); ?></h3>
                <h4><?php echo ($vo["newstime"]); ?></h4>
