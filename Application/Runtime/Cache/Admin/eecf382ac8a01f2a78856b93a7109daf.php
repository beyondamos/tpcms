...
<div class="cont">
    <div class="contmain">
        ...
        <div class="boxi">
            ...
            <!-- 表格顶部搜索区 -->
            <div class="boxoper">
                <a href="<?php echo U('Adv/add');?>">添加广告</a>
            ...
            <table class="table table-hover boxtable">
                ...
                <tr>
                    ...
                    <th class="col-md-2 text-vm">广告名称</th>
                    <th class="col-md-6 text-vm">广告位置</th>
                    <th class="col-md-1 text-vm text-center">操作</th>
                </tr>
                </thead>
                <tbody>
                <?php if(is_array($adv_data)): $i = 0; $__LIST__ = $adv_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td class="text-vm"><?php echo ($vo["id"]); ?></td>
                        <td class="text-vm"><?php echo ($vo["adv_name"]); ?></td>
                        <td class="text-vm"><?php echo ($vo["adv_position"]); ?></td>
                        <td class="text-vm">
